...
// Initial data from data.json - this will be used as fallback
const initialData: PortfolioData = {
  ...
  testimonials: [
    ...
    },
    {
      ...
      company: "JobSwire",
      text: "Yasin ile beraber yaklaşık 6 aydır aynı proje üzerinde çalışıyoruz. Kendisi Frontend Development anlamında oldukça yetkin ve bilgili. Ayni zamanda yeni teknojileri öğrenmek, onları kullanmak konusunda fazlasıyla hevesli, öğrenmeye açık. Takım içi iletişimde de kendisi ile hiçbir problem yaşamadık. Yasin ile çalışılmasını kesinlikle tavsiye ederim."
    },
    {
      id: 5,
      name: "Sena Gümüşer",
  ...
  const refreshData = useCallback(async () => {
    ...
    try {
      ...
      if (firebaseData) {
        ...
        // Use initial data if Firebase data is not available
        setData(initialData);
      }
    } catch (error) {
